...
public:
  ...
  Solid * cylinder(int solidNum);
  Solid * sphere(int solidNum);
  Solid * hemisphere(int solidNum);
  Solid * bullet(int solidNum);
  Solid * torus(int solidNum);
  Solid * disk(int solidNum);
  Solid * trefoil(int solidNum);
  Solid * cone(int solidNum);
