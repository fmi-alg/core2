 ...
 * Since Core 2.1.0
 *
 * Notes: this file contains routines for complex polynomials p(z).
 * It should be eventually transferred into inc/CORE.
 *
 * It currently supports only "complex-valued p(z)"  (i.e., z is
 * complex, but the coefficients are still real.
 * The case of complex coefficients is started but not completed.
 *
 ***************************************************/
