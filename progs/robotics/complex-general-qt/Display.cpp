...
// Global Variables in complex-general-qt.cpp
extern QuadTree* QT;
...
//bool step(false);
extern bool step; // define in complex.cpp or complex-general-qt.cpp
...
void Display::drawRobot(Pose p, Color c){
    ...
    for (Triangle & tri:compRoboTriangles) {
        ...
        Color used_c = c;
        if (i++ < 4) { // use some special color for the first 4 triangles of the robot
