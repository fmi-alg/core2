...
extern double robotMinMaxRadiusRatio;
...
public:
    ...
    BasisShape getExpandedNSS(Triangle tri, bool &mirrored);

    bool checkIntersectNSS(Corner c, BasisShape &expanded_NSS, bool mirrored);

    bool checkIntersectNSS(Wall c, BasisShape &expanded_NSS, bool mirrored);
};//class Box
