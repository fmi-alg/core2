...
int main(int argc, char* argv[]) {
    ...
    sprintf(WAFR2016cfgName[1], "WAFR2016_maze_");
    sprintf(WAFR2016cfgName[2], "WAFR2016_rand100_");
    sprintf(WAFR2016cfgName[3], "WAFR2016_Hole-in-Wall_");
    sprintf(WAFR2016cfgName[4], "WAFR2016_8-ways_");
    ...
    for(int all=0;all<7;++all){
        for(int abcdef=0;abcdef<3;++abcdef){
            ...
            cfgName =  ss;
            fprintf(stderr, "%s\n", cfgName.c_str());
            sprintf(ss, "table2_%s%c.txt", WAFR2016cfgName[all], 'a'+abcdef);
            fp = fopen(ss, "w");
    ...
    for(int all=0;all<7;++all){
        for(int abcdef=0;abcdef<3;++abcdef){
            ...
            cfgName =  ss;
            fprintf(stderr, "%s\n", cfgName.c_str());
            sprintf(ss, "table1_%s%c%c.txt", WAFR2016cfgName[all], 'd'+abcdef, 'd'+abcdef);
            fp = fopen(ss, "w");
