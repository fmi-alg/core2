...
{
    switch(key){
        case GLUT_KEY_LEFT: m_deltaDis[0]-=0.1f/m_Scale; break;
        case GLUT_KEY_RIGHT: m_deltaDis[0]+=0.1f/m_Scale; break;
        case GLUT_KEY_UP: m_deltaDis[1]-=0.1f/m_Scale; break;
        case GLUT_KEY_DOWN: m_deltaDis[1]+=0.1f/m_Scale; break;
    }
