...
Function prototypes.
---------------------------------------------------------------------*/
char	SegSegInt( Point2d a, Point2d b, Point2d c, Point2d d, tPointd p );
char	ParallelInt( Point2d a, Point2d b, Point2d c, Point2d d, tPointd p );
bool	Between( Point2d a, Point2d b, Point2d c );
void	Assigndi( tPointd p, Point2d a );
...
char	SegSegInt( tPointd a, tPointd b, tPointd c, tPointd d, tPointd p )
{
   ...
   if      ( (0.000001 < s) && (s < 0.999999) &&
             (0.000001 < t) && (t < 0.999999) )
     code = '1';
   else //if ( (0.0 > s) || (s > 1.0) ||
        //     (0.0 > t) || (t > 1.0) )
     code = '0';
