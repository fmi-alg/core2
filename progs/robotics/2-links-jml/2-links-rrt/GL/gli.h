...
class gli {
    ...
    typedef void (* GLI_KEYBOARD_FUNC)  ( unsigned char key, int x, int y );
...
public:
	...
	static void gliKeyboardFunc(GLI_KEYBOARD_FUNC func){
		m_keyboardFunc = func;
	}
...
protected:
    ...
    static void gliKeyboardFunc(unsigned char key, int x, int y);
...
private:
    ...
    static GLI_KEYBOARD_FUNC m_keyboardFunc;
