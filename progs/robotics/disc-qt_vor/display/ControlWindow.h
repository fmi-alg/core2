...
private slots:
    ...
    void on_radioButton_rand_clicked(bool checked);
    void on_radioButton_bfs_clicked(bool checked);
    void on_radioButton_greedy_clicked(bool checked);
    void on_radioButton_vor_clicked(bool checked);
